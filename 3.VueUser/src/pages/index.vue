	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0px 40px","borderColor":"#eee","alignItems":"center","color":"#fff","textAlign":"right","display":"flex","justifyContent":"flex-end","overflow":"hidden","top":"0","borderRadius":"0","left":"0","background":"rgba(246,77,54,1)","borderWidth":"0px","width":"100%","fontSize":"14px","lineHeight":"80px","position":"fixed","borderStyle":"solid","height":"80px","zIndex":"1002"}'>
			...
			<div :style='{"margin":"0","left":"40px","background":"none","display":"inline-block","width":"30%","position":"absolute","float":"left","height":"80px"}'>
			  <span @click="goMenu('/index/home')" :style='{"padding":"0px","color":"inherit","alignItems":"center","display":"flex","width":"100%","lineHeight":"1.5","fontSize":"18px","fontWeight":"600","height":"80px"}'>摄影师分享交流社区</span>
			</div>
			...
			<div id="search" class="search" :style='{"padding":"0","margin":"0","alignItems":"center","flexWrap":"wrap","background":"none","display":"none","float":"left","height":"auto"}'>
				...
				<div :style='{"padding":"0","margin":"0","background":"none","display":"inline-block"}' class="input" v-if="queryIndex==0">
					<el-input v-model="zuopinxinxizuopinleibie" placeholder="作品类别"></el-input>
				</div>
				<div :style='{"padding":"0","margin":"0","borderRadius":"0 20px 20px 0","background":"none","display":"inline-blockinline-block"}' class="btn" v-if="queryIndex==0">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px 0 10px","margin":"0","color":"#333","borderRadius":"0 20px 20px 0","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="search('zuopinxinxi')">
...
export default {
    data() {
		...
		queryIndex: 0,
		zuopinxinxizuopinleibie: '',
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","首页总数"],"appFrontIcon":"cuIcon-attentionfavor","buttons":["新增","查看","修改","删除","首页总数"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-list","buttons":["新增","查看","修改","删除"],"menu":"作品类别","menuJump":"列表","tableName":"zuopinleibie"}],"menu":"作品类别管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核","作品类别统计","用户发布统计","查看评论","首页总数","首页统计"],"appFrontIcon":"cuIcon-paint","buttons":["查看","修改","删除","审核","查看评论","首页总数","首页统计"],"menu":"作品信息","menuJump":"列表","tableName":"zuopinxinxi"}],"menu":"作品信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告资讯","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告资讯分类","tableName":"newstype"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-addressbook","buttons":["查看","修改"],"menu":"系统简介","tableName":"systemintro"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-camera","buttons":["新增","查看","修改","删除"],"menu":"友情链接","tableName":"friendlink"},{"allButtons":["查看","删除"],"appFrontIcon":"cuIcon-skin","buttons":["查看","删除"],"menu":"在线留言","tableName":"onlinemessage"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-form","buttons":["查看","修改"],"menu":"轮播图管理","tableName":"config"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","审核","作品类别统计","用户发布统计","查看评论","首页总数","首页统计"],"appFrontIcon":"cuIcon-paint","buttons":["新增","查看"],"menu":"作品信息列表","menuJump":"列表","tableName":"zuopinxinxi"}],"menu":"作品信息模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","首页总数"],"appFrontIcon":"cuIcon-attentionfavor","buttons":["查看"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核","作品类别统计","用户发布统计","查看评论","首页总数","首页统计"],"appFrontIcon":"cuIcon-paint","buttons":["新增","查看","修改","删除"],"menu":"作品信息","menuJump":"列表","tableName":"zuopinxinxi"}],"menu":"作品信息管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","审核","作品类别统计","用户发布统计","查看评论","首页总数","首页统计"],"appFrontIcon":"cuIcon-paint","buttons":["新增","查看"],"menu":"作品信息列表","menuJump":"列表","tableName":"zuopinxinxi"}],"menu":"作品信息模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
    ...
    methods: {
      ...
      search(tablename) {
        if (this.queryIndex == 0 && this.zuopinxinxizuopinleibie) {
          this.$router.push({path: '/index/' + tablename, query: {indexQueryCondition: this.zuopinxinxizuopinleibie}});
        }
      },
