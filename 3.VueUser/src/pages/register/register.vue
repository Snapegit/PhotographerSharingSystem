<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20240111/52850f190df14e968d04c5b7fe9d35f2.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"border":"1px solid #eee","padding":"30px 3% 30px","boxShadow":"0px 26px 26px -30px #999","margin":"0px auto","borderRadius":"20px","textAlign":"center","background":"rgba(255,255,255,.3)","width":"50vw","position":"relative","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"margin":"0px auto 10px","-webkit-text-stroke":"6px transparent","color":"#fff","textAlign":"center","background":"linear-gradient(178deg, rgba(0,0,0,1) 0%, rgba(163,86,80,0) 55%, rgba(0,0,0,1) 55%, rgba(186,86,79,0) 100%)","-webkitTextFillColor":"#ffffff","width":"100%","letterSpacing":"6px","lineHeight":"44px","fontSize":"26px","-webkitBackgroundClip":"text"}'>摄影师分享交流社区注册</p></div>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","textAlign":"left","height":"auto"}' v-if="tableName=='yonghu'" prop="yonghuming">
				<div v-if="true" :style='{"padding":"0 10px","color":"#000","textAlign":"right","background":"none","display":"inline-block","width":"100px","lineHeight":"36px","fontSize":"14px"}' :class="changeRules('yonghuming')?'required':''">用户名：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","textAlign":"left","height":"auto"}' v-if="tableName=='yonghu'" prop="shouji">
				<div v-if="true" :style='{"padding":"0 10px","color":"#000","textAlign":"right","background":"none","display":"inline-block","width":"100px","lineHeight":"36px","fontSize":"14px"}' :class="changeRules('shouji')?'required':''">手机：</div>
