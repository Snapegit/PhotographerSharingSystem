		...
		<div class="attr" :style='{"padding":"0","margin":"0","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"51%","position":"relative","justifyContent":"space-between","order":"2"}'>
			...
			<div class="info" :style='{"minHeight":"460px","padding":"20px","margin":"0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","order":"2"}'>
				<div class="item" :style='{"padding":"0 8px","margin":"0 0 10px 0","borderColor":"#eccc19","alignItems":"center","display":"flex","justifyContent":"space-between","overflow":"hidden","borderRadius":"0px","background":"none","borderWidth":"0 0 0px","width":"100%","lineHeight":"auto","borderStyle":"solid","height":"50px"}'>
					...
					<div @click="storeup(41)" v-show="!isStoreup" :style='{"border":"0px solid #eccc19","cursor":"pointer","padding":"0 10px","lineHeight":"32px","borderRadius":"20px","background":"linear-gradient(to right,#f67536,#f64d36),#f64d36"}'><i v-if="true" :style='{"color":"#fff","fontSize":"18px"}' class="el-icon-circle-plus-outline"></i><span :style='{"color":"#fff","fontSize":"15px"}'>点我关注</span></div>
					<div @click="storeup(-1)" v-show="isStoreup" :style='{"border":"0px solid #eccc19","cursor":"pointer","padding":"0 10px","lineHeight":"32px","borderRadius":"20px","background":"linear-gradient(to right,#f67536,#f64d36),#f64d36"}'><i v-if="true" :style='{"color":"#fff","fontSize":"18px"}' class="el-icon-remove-outline"></i><span :style='{"color":"#fff","fontSize":"15px"}'>取消关注</span></div>
				</div>
				...
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","alignItems":"center","background":"#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"right","width":"auto","fontSize":"15px","lineHeight":"32px","height":"32px"}'>手机</div>
					<div  :style='{"padding":"5px 10px 0","fontSize":"15px","lineHeight":"24px","color":"#999","flex":"1","height":"auto"}'>{{detail.shouji}}</div>
				</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getStoreupStatus(){
        if(localStorage.getItem("frontToken")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 41, refid: this.detail.id, tablename: 'yonghu', userid: localStorage.getItem('frontUserid')}}).then(res => {
