...
<div :style='{"width":"100%","padding":"30px 18% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="作品名称" prop="zuopinmingcheng">
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="作品类别" prop="zuopinleibie">
            <el-select v-model="ruleForm.zuopinleibie" placeholder="请选择作品类别" :disabled=" false  ||ro.zuopinleibie" >
              <el-option
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="摄影标签" prop="sheyingbiaoqian">
            <el-input v-model="ruleForm.sheyingbiaoqian" 
                placeholder="摄影标签" clearable :disabled=" false  ||ro.sheyingbiaoqian"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="作品封面" v-if="type!='cross' || (type=='cross' && !ro.zuopinfengmian)" prop="zuopinfengmian">
            <file-upload
            tip="点击上传作品封面"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' class="upload" v-else label="作品封面" prop="zuopinfengmian">
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="拍摄地点" prop="paishedidian">
            <el-input v-model="ruleForm.paishedidian" 
                placeholder="拍摄地点" clearable :disabled=" false  ||ro.paishedidian"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="发布日期" prop="faburiqi">
              <el-date-picker
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="光圈大小" prop="guangquandaxiao">
            <el-input v-model="ruleForm.guangquandaxiao" 
                placeholder="光圈大小" clearable :disabled=" false  ||ro.guangquandaxiao"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="快门速度" prop="kuaimensudu">
            <el-input v-model="ruleForm.kuaimensudu" 
                placeholder="快门速度" clearable :disabled=" false  ||ro.kuaimensudu"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="感光度" prop="ganguangdu">
            <el-input v-model="ruleForm.ganguangdu" 
                placeholder="感光度" clearable :disabled=" false  ||ro.ganguangdu"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="镜头焦距" prop="jingtoujiaoju">
            <el-input v-model="ruleForm.jingtoujiaoju" 
                placeholder="镜头焦距" clearable :disabled=" false  ||ro.jingtoujiaoju"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"48%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="作品推文" prop="zuopintuiwen">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/zuopinleibie/zuopinleibie', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`zuopinxinxi/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('zuopinxinxi/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`zuopinxinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
